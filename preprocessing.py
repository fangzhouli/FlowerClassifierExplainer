...
# -*- coding: utf-8 -*-
"""
Created on Wed Oct 28 23:25:00 2020
...
def preprocess_data(folder_path = "./animals-10/raw-img/",img_size=100,test_size = 0.2):
    '''
    input:
        folder_path:local path to the folder of raw images of animals-10 dataset, the folder contains 10 subfolders
        img_size: desired size of output images
        test_size: proportion of the dataset that are split into test set
    output:
    ...
    for category,translation in categories.items():
        ...
        label = animals.index(translation)
...
if __name__ == '__main__':            
    x_train,x_test,y_train,y_test = preprocess_data("./example-10/raw-img/",100,0.3)